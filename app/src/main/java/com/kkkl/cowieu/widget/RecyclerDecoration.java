package com.kkkl.cowieu.widget;
...
/**
 * ClassName: RecyclerDecoration
 * Description: 分割线
 *
 * @author zhaowei
 * @date 2024/1/20 12:19
 */
public class RecyclerDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public RecyclerDecoration(Context context, int orientation, boolean isShowRightLine) {
        TypedArray a = context.obtainStyledAttributes(ATTRS);
        this.mDivider = a.getDrawable(0);
